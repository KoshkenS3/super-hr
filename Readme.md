...
**Папки:**
- `src/entities/` - Описание данных для базы
- `src/keyboards/` - Кнопки для бота
- `src/scenes/` - Диалоги с пользователем
- `src/services/` - Работа с данными и уведомления
- `src/types/` - Описание типов данных
